export const htmlContent: string = `
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>&copy; 2024 FESWEB. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to FESWEB!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at FESWEB. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The FESWEB Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The FESWEB Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 FESWEB. All rights reserved.</p>
            </div>
